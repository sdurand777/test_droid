...
# proj pixel coords to 3D homogeneous pts
...
def rotation_matrix_to_quaternion(matrix):
    ...
    return torch.tensor([qx, qy, qz, qw], device="cuda")
...
def projective_transform(poses, depths, intrinsics, ii, jj, jacobian=False, return_depth=False):
    ...
    # calib IVM
    #Gij.data[:,ii==jj] = torch.as_tensor([-0.1496043798897528, -0.0001443549664989622, -0.00022337423605555602, 0.0, 0.0, 0.0, 1.0], device="cuda")

    # ------------------- test extrinseques IVM
# Matrice de rotation et vecteur de translation
#     rotation_matrix = torch.tensor([
#         [0.9999984645782758, -0.00031116633077584566, -0.00172936557814299],
#         [0.0003090362999546388, 0.9999992098611167, -0.001231682511199452],
#         [0.001729745998158656, 0.001231145402613623, 0.9999977645884023]
#     ], device="cuda")
#
#     translation_vector = torch.tensor([-0.1496043798897528, -0.0001443549664989622, -0.00022337423605555602], device="cuda")
#
# # Convertir la matrice de rotation en quaternion
#     quaternion = rotation_matrix_to_quaternion(rotation_matrix)
#
# # Combiner translation et quaternion en un vecteur de 7 valeurs
#     transformation_vector = torch.cat((translation_vector, quaternion))
#
#     print("+++++++++++++++ transfo vector : ", transformation_vector)
#
#     Gij.data[:,ii==jj] = torch.as_tensor(transformation_vector, device="cuda")
